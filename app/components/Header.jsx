              ...
              >
                <div className="grid grid-cols-3 gap-1 p-5">
                  {serviceItems.map((service) => (
                    <Link
                      key={service}
                      href={service === 'Interior Renovation' ? '/interior-renovation' : service === 'Turnkey Solutions' ? '/turnkey-solutions' : ['Exterior Renovation','Pool Construction','Landscaping & Gardens'].includes(service) ? '/outdoor-services' : '/services'}
