...
const IMG = {
  ...
  royal_tech_ofs: '/images/ofs_logo.jpeg',
  royal_tech_ogt: '/images/Royal_Tech_1.png',
  royal_tech_igt: '/images/Capture.PNG',
  royal_tech_5: '/images/Capture2.PNG',
};
            ...
            <div className="flex animate-scroll-continuous">
              {[...Array(3)].map((_, setIndex) => (
                <div key={setIndex} className="flex gap-12 px-6">
                  {[IMG.royal_tech_group, IMG.royal_tech_ofs, IMG.royal_tech_ogt, IMG.royal_tech_igt, IMG.royal_tech_5].map((logo, idx) => (
                    <div
                      key={idx}
